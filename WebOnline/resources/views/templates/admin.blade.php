...
<head>
  ...
  <link rel="stylesheet" href="{{asset('fontawesome-free-5.13.1/css/all.min.css')}}">
  <!-- Ionicons -->
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="{{URL::to('/tongquan') }}" class="nav-link">
          ...
          <a href="" class="nav-link">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
              <a href="{{URL::to('/sanpham')}}" class="nav-link">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
              <a href="{{URL::to('/manager_order')}}" class="nav-link">
              ...
              <li class="nav-item">
                <a href="pages/mailbox/read-mail.html" class="nav-link">
                  <i class="fa fa-hand-holding-box nav-icon"></i>
                  <p>Xuất hủy</p>
                </a>
              </li>
            </ul>
          ...
          {{-- <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="pages/mailbox/mailbox.html" class="nav-link">
                  <i class="fas fa-person-carry nav-icon"></i>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
              <a href="{{URL::to('/nhanvien')}}"  class="nav-link">
                {{-- {{ route('nhanvien') }}" --}}
                {{-- http://127.0.0.1:8000/sanpham  --}}
          ...
          {{-- <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="pages/mailbox/mailbox.html" class="nav-link">
                  <i class="fa fa-users-class nav-icon"></i>
                  <p>Nhà cung cấp</p>
                </a>
              </li>
              <li class="nav-item">
              ...
              <li class="nav-item">
                <a href="pages/mailbox/read-mail.html" class="nav-link">
                  <i class="fa fa-slideshare nav-icon"></i>
                  <p>Kênh bán hàng</p>
                </a>
              </li>
              <li class="nav-item">
